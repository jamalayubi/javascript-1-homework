...
| :seedling: __[errors: primitives](./jl-errors-primitive-types.md)__ | :white_check_mark:| Uncomplicated | :white_check_mark: | |
...
| :seedling: __[how functions work](./jl-functions.md)__ |:wavy_dash: |kinda counfusing, hope on Sunday we work on this | | these exercises are like the swaps, once you get them they are not so bad. before that they are quite tricky. the goal is to master tracing values (variable -> argument -> function call -> parameter -> return value -> variable) |
